...
ExponentialSmoothingModelT = TypeVar('ExponentialSmoothingModelT', bound='ExponentialSmoothingModel')
ProphetModelT = TypeVar('ProphetModelT', bound='ProphetModel')
...
def k_folds_cross_validation(
        df: pd.Series, k_folds: int, season_length: int,
        model_cls: Union[Type[ExponentialSmoothingModelT], Type[ProphetModelT]],
...
def exponential_weighting(df: pd.Series, lag: int) -> pd.Series:
    """
