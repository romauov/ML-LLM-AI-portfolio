...
from clients.muksun.file_loader import load_files
...
class ConversatorMuksun(Conversator):
    ...
    async def generate_reply(self, message: Message):
        ...
        products_list = self.price_list['Наименование товара'].unique(
        ).tolist()
        messages = [
        ...
        tools = generate_tools('Получение цен, сроков хранения и температуры для списка продуктов')
                ...
                if function_to_call:
                    ...
                    if function_name == 'get_prices':
                        ...
                        function_response = get_prices(df=self.price_list,
                                                       ...
                                                       product_col_name='Наименование товара'
                                                       )
