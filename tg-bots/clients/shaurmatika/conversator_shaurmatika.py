...
from clients.shaurmatika.file_loader import load_files
...
class ConversatorShaurmatika(Conversator):
    ...
    async def generate_reply(self, message: Message):
        ...
        products_list = self.price_list['Наименование'].unique(
        ).tolist()
        messages = [
