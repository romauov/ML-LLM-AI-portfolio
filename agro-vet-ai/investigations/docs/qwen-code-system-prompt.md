# Qwen Code System Prompt (Reference)

Этот файл содержит оригинальный системный промпт от Qwen Code для использования в качестве образца при разработке промпта для ветеринарного ассистента-расследователя.
