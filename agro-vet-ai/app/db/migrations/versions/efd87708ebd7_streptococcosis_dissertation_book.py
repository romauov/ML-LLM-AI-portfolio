"""streptococcosis dissertation book

Revision ID: efd87708ebd7
Revises: b98e3293817c
Create Date: 2025-12-05 16:30:45.190996
...
revision = 'efd87708ebd7'
down_revision = 'b98e3293817c'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    all_dump_files = [
        'source_document_16.sql',
        'knowledge_base_chunks_16.sql',
        'images_16.sql',
    ]
...
def downgrade():
    op.execute("DELETE FROM source_document WHERE name = 'Патоморфология стрептококкоза свиней в группах доращивания и откорма';")
