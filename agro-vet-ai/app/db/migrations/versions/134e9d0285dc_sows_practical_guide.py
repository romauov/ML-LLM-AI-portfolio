"""sows practical guide

Revision ID: 134e9d0285dc
Revises: 5ced7b94715f
Create Date: 2025-12-11 14:17:44.388662
...
revision = '134e9d0285dc'
down_revision = '5ced7b94715f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    all_dump_files = [
        'source_document_18.sql',
        'knowledge_base_chunks_18.sql',
        'images_18.sql',
    ]
...
def downgrade():
    op.execute("DELETE FROM source_document WHERE name = 'Свиноматки. Практическое руководство по менеджменту лактационного периода и продуктивности свиноматок';")
