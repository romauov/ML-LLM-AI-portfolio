"""pig breeders workshop

Revision ID: 0123523dbeac
Revises: b5305ffcb20e
Create Date: 2025-12-23 11:34:23.683943
...
revision = '0123523dbeac'
down_revision = 'b5305ffcb20e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    all_dump_files = [
        'source_document_20.sql',
        'knowledge_base_chunks_20.sql',
        'images_20.sql',
    ]
...
def downgrade():
    op.execute("DELETE FROM source_document WHERE name = 'Практикум свиновода. Наблюдай и действуй!';")
