...
from knowledge.parsing_piplines.sows_practical_guide.constants import SOURCE_DOCUMENT, CHAPTERS, JSON_BOOK, \
...
def add_source():
    ...
    Свиноматки. Практическое руководство по менеджменту лактационного периода и продуктивности свиноматок
    """
