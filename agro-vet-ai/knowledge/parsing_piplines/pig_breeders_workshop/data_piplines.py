...
from knowledge.parsing_piplines.pig_breeders_workshop.constants import SOURCE_DOCUMENT, CHAPTERS, JSON_BOOK, \
...
def add_source():
    ...
    Практикум свиновода. Наблюдай и действуй!
    """
...
def add_chunks():
    ...
    for page in data['pages']:
        ...
        print(page_number, chapter_title, content)
