...
from knowledge.parsing_piplines.antimicrobial_usage_in_pig_production.constants import JSON_BOOK, CHAPTERS, \
    EXCLUDED_PAGES, SOURCE_DOCUMENT
...
def process_chunks():
    ...
    for chunk_number, chunk in enumerate([*texts, *tables, *images], start=1):
        ...
        if metadata and 'REFERENCES' in metadata.values():
            continue
